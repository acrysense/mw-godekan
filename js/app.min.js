...
document.addEventListener('DOMContentLoaded', function () {
  ...
  //         const opacity = 0.1 + intersectionRatio * 0.7;
  ...
  //     entries.forEach(entry => {
  //         const { target, intersectionRatio } = entry;
  //         const adjustedRatio = Math.min(1, intersectionRatio / 0.5);
  //         const opacity = 0.1 + adjustedRatio * 0.9;
  //         const scale = 0.95 + adjustedRatio * 0.05;
  //         target.style.opacity = opacity;
  //         target.style.transform = `scale(${scale})`;
  //     });
  // }, {
  //     threshold: Array.from({ length: 51 }, (_, i) => i / 100)
  // });
